...
function calcularVerbas(){
    ...
    if(botao_com_justa_causa.checked){
        ...
        resultadoFinal.innerHTML = "<div>Seu saldo de salário é: R$ " + saldoSalario + "</div>"+
        "<div><p>Considerando a demissão por justa causa, você tem direito ao seu saldo de salário, somente, bem como, férias vencidas se for o caso.</p><p>No entanto, é importante lembrar que você também terá direito a receber o 1/3 constitucional de férias vencidas, caso possua, salário família se for o caso e as suas horas extras caso haja.</p><p>Para isso, busque a ajuda de um advogado especialista que poderá te auxiliar e dizer com certeza os seus direitos.</p></div>"
    }
        ...
        "<div>13º salário porporcional: R$ " + salario13 + "</div>" +
        "<div>Férias proporcionais mais 1/3: R$ " + ferias + "</div>"+
        "<div>Seu FGTS é: R$ " + FGTS + "</div>" +
        "<div> Sua multa de 40% do FGTS é: R$ " + multaFgts + "</div>" +
        "<div>Valor total da rescisão: R$ " + rescisaoTotal + "</div>" +
        "<div><p>É importante lembrar que nesse caso o empregado ainda terá direito ao aviso prévio, seja ele trabalhado ou indenizado, bem como, receber suas férias vencidas mais 1/3 se for o caso</p><p>Além disso, neste caso o empregado também terá direito a sacar seu FGTS e receber o seguro desemprego.</p></div>"
